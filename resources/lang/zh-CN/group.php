...
return [
    ...
    'contest' =>[
        'arrangeContest' => '发布考试' ,
        'arrange' => '发布',
        'successArrange' => '考试发布成功，是否跳转到考试页面?',
        'jumpTo' => '跳转',
        'return' => '返回',
        'assignee' => '负责人',
        'contestName' => '考试名',
        'contestBeginTime' => '考试开始时间',
        'contestEndTime' => '考试结束时间',
        'publicContest' => '公开考试',
        'practiceContest' => '训练赛',
        ...
        'description' => '考试简介',
        'update' => '更新',
        'assignMember' => '指定考试负责人',
        'cancel' => '取消',
        'problemCode' => '题号',
        'close' => '关闭',
        'add' => '添加',
        'errorContestTimeShort' => '考试时间起码1分钟。',
        'noChargeContest' => '你没有负责任何考试。',
        'noContestInGroup' => '本群组尚未创建考试。',
        'noOneAssigned' => '本考试没有指定负责人，点击以指定。',
        'deleteProblemTip' => '删除这个题目',
        'errorProblemNonExist' => '题目不存在',
        'errorLoading' => '正在加载考试信息，慢点',
        'errorEmptyName' => '考试名不能为空',
        'errorEmptyBeginTime' => '考试开始时间不能为空',
        'errorEmptyEndTime' => '考试结束时间不能为空',
    ],
    'problem' => [
        'title' => '群组题目管理',
        'empty' => '没有你可以操作的题目',
