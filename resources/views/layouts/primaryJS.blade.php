...
<script>
    ...
    window.addEventListener("load",function() {
        ...
        console.info("\HASAAOSE - High Availability and Safety Automatic Algorithm Online-Judge System for Examinations based on NOJ 0.4.2\n\nHASAAOSE Development Team Leader: John Zhang\nNOJ Development Team Leader: John Zhang\nOrganization: Association of Advanced Algorithms of NJUPT\nDevelopers: John Zhang, David Diao and other dedicated contributor of the open-source community\nVersion: {{version()}}\nInsider Alias: HASAAOSE\n\n");
