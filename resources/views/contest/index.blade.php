    ...
    <div class="row">
        <div class="col-sm-12 col-md-8">
            <paper-card class="animated bounceInRight p-0" type="none">
                ...
                <div>
                    <span class="badge badge-rule @if($filter['rule']==5) selected @endif" onclick="applyFilter('rule',this)" data-rule="5"><i class="MDI trophy"></i> {{__("contest.filter.fsjs")}}</span>
