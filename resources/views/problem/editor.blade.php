            ...
            <left-side>
                <div class="prob-header animated pre-animated cm-performance-optimistic">
                    ...
                    @if($contest_mode)
                        ...
                        @else
                            <info-badge data-toggle="tooltip" data-placement="top" title="{{__("problem.totalpoints")}}"><i class="MDI checkbox-multiple-marked-circle"></i> {{$detail["points"]}} 分</info-badge>
                        @endif
                    @else
    ...
    <script>
        ...
        $( "#verdict_info" ).click(function() {
            if($("#verdict_text").hasClass('cm-popover-decoration')){
                // alert('<pre class="mb-0" style="white-space: pre-wrap;">'+$("#verdict_info").attr('data-content')+'</pre>', $("#verdict_info").attr('title'),'bug',"true");
