            ...
            @else
                <div class="mb-5">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <tr>
                                <th scope="row"><span style="color:#7a8e97"><i class="MDI checkbox-blank-circle"></i> NOT SUBMIT</span></td>
                                <td nowrap>未提交</td>
                                <td>本题当前未作答</td>
                            </tr>
                            <tr>
                                <th scope="row"><span class="wemd-blue-text"><i class="MDI checkbox-blank-circle"></i> Submitting...</span></td>
                                <td nowrap>提交中</td>
                                <td>正在提交作答中，请勿关闭页面</td>
                            </tr>
                            <tr>
                                <th scope="row" nowrap><span class="wemd-black-text"><i class="MDI checkbox-blank-circle"></i> Submission Error</span></td>
                                <td nowrap>提交错误</td>
                            ...
                            <tr>
                                <th scope="row"><span class="wemd-orange-text"><i class="MDI checkbox-blank-circle"></i> Compile Error</span></td>
                                <td nowrap>编译错误</td>
                                <td>提交已经评测但编译失败，请根据编译信息修改自己的代码，大多数情况下这是由于自己引用了不支持的第三方库</td>
                            </tr>
                            <tr>
                                <th scope="row"><span class="wemd-black-text"><i class="MDI checkbox-blank-circle"></i> System Error</span></td>
                                <td nowrap>系统错误</td>
                                <td>请联系监考</td>
                            </tr>
                        </tbody>
